 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/customer_label_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\CustomerLabel;
use Google\Ads\GoogleAds\V1\Services\CustomerLabelOperation;
use Google\Ads\GoogleAds\V1\Services\GetCustomerLabelRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCustomerLabelsRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCustomerLabelsResponse;
...
class CustomerLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.CustomerLabelService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the customer-label relationship to fetch.
     ...
     * ```
     *
     * @param string                   $customerId   ID of the customer whose customer-label relationships are being modified.
     * @param CustomerLabelOperation[] $operations   The list of operations to perform on customer-label relationships.
     * @param array                    $optionalArgs {
     *                                               Optional.
     *
