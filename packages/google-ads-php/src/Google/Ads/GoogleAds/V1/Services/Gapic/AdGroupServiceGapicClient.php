 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/ad_group_service.proto
...
use Google\Ads\GoogleAds\V1\Services\GetAdGroupRequest;
use Google\Ads\GoogleAds\V1\Services\MutateAdGroupsRequest;
...
class AdGroupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.AdGroupService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the ad group to fetch.
     ...
     * ```
     *
     * @param string             $customerId   The ID of the customer whose ad groups are being modified.
     * @param AdGroupOperation[] $operations   The list of operations to perform on individual ad groups.
     * @param array              $optionalArgs {
     *                                         Optional.
     *
