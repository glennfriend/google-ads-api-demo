 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/billing_setup_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\BillingSetup;
use Google\Ads\GoogleAds\V1\Services\BillingSetupOperation;
use Google\Ads\GoogleAds\V1\Services\GetBillingSetupRequest;
use Google\Ads\GoogleAds\V1\Services\MutateBillingSetupRequest;
use Google\Ads\GoogleAds\V1\Services\MutateBillingSetupResponse;
...
class BillingSetupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.BillingSetupService';
