 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/campaign_service.proto
...
use Google\Ads\GoogleAds\V1\Services\GetCampaignRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCampaignsRequest;
...
class CampaignServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.CampaignService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the campaign to fetch.
     ...
     * ```
     *
     * @param string              $customerId   The ID of the customer whose campaigns are being modified.
     * @param CampaignOperation[] $operations   The list of operations to perform on individual campaigns.
     * @param array               $optionalArgs {
     *                                          Optional.
     *
