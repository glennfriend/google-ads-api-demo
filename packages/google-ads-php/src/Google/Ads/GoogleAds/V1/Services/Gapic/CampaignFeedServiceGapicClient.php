 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/campaign_feed_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\CampaignFeed;
use Google\Ads\GoogleAds\V1\Services\CampaignFeedOperation;
use Google\Ads\GoogleAds\V1\Services\GetCampaignFeedRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCampaignFeedsRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCampaignFeedsResponse;
...
class CampaignFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.CampaignFeedService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the campaign feed to fetch.
     ...
     * ```
     *
     * @param string                  $customerId   The ID of the customer whose campaign feeds are being modified.
     * @param CampaignFeedOperation[] $operations   The list of operations to perform on individual campaign feeds.
     * @param array                   $optionalArgs {
     *                                              Optional.
     *
