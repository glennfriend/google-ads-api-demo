 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/keyword_view_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\KeywordView;
use Google\Ads\GoogleAds\V1\Services\GetKeywordViewRequest;
...
class KeywordViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.KeywordViewService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the keyword view to fetch.
