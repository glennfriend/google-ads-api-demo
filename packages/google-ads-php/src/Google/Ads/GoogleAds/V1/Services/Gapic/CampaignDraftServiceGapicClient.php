...
use Google\Ads\GoogleAds\V1\Services\GetCampaignDraftRequest;
use Google\Ads\GoogleAds\V1\Services\ListCampaignDraftAsyncErrorsRequest;
use Google\Ads\GoogleAds\V1\Services\ListCampaignDraftAsyncErrorsResponse;
use Google\Ads\GoogleAds\V1\Services\MutateCampaignDraftsRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCampaignDraftsResponse;
use Google\Ads\GoogleAds\V1\Services\PromoteCampaignDraftRequest;
...
class CampaignDraftServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.CampaignDraftService';
