 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/ad_group_ad_service.proto
...
use Google\Ads\GoogleAds\V1\Services\GetAdGroupAdRequest;
use Google\Ads\GoogleAds\V1\Services\MutateAdGroupAdsRequest;
...
class AdGroupAdServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.AdGroupAdService';
     ...
     * @param AdGroupAdOperation[] $operations   The list of operations to perform on individual ads.
     * @param array                $optionalArgs {
     *                                           Optional.
     *
