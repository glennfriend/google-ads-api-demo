 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/custom_interest_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\CustomInterest;
use Google\Ads\GoogleAds\V1\Services\CustomInterestOperation;
use Google\Ads\GoogleAds\V1\Services\GetCustomInterestRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCustomInterestsRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCustomInterestsResponse;
...
class CustomInterestServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.CustomInterestService';
