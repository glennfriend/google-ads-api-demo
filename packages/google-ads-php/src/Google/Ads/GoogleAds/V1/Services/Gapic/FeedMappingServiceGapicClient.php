 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/feed_mapping_service.proto
...
use Google\Ads\GoogleAds\V1\Services\GetFeedMappingRequest;
use Google\Ads\GoogleAds\V1\Services\MutateFeedMappingsRequest;
use Google\Ads\GoogleAds\V1\Services\MutateFeedMappingsResponse;
...
class FeedMappingServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.FeedMappingService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the feed mapping to fetch.
     ...
     * ```
     *
     * @param string                 $customerId   The ID of the customer whose feed mappings are being modified.
     * @param FeedMappingOperation[] $operations   The list of operations to perform on individual feed mappings.
     * @param array                  $optionalArgs {
     *                                             Optional.
     *
