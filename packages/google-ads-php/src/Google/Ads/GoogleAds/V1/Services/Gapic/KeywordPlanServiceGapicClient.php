 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/keyword_plan_service.proto
...
use Google\Ads\GoogleAds\V1\Services\GenerateForecastMetricsRequest;
use Google\Ads\GoogleAds\V1\Services\GenerateForecastMetricsResponse;
use Google\Ads\GoogleAds\V1\Services\GenerateHistoricalMetricsRequest;
use Google\Ads\GoogleAds\V1\Services\GenerateHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V1\Services\GetKeywordPlanRequest;
use Google\Ads\GoogleAds\V1\Services\KeywordPlanOperation;
use Google\Ads\GoogleAds\V1\Services\MutateKeywordPlansRequest;
use Google\Ads\GoogleAds\V1\Services\MutateKeywordPlansResponse;
...
class KeywordPlanServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.KeywordPlanService';
