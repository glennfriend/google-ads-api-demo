 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/mutate_job_service.proto
...
use Google\Ads\GoogleAds\V1\Services\CreateMutateJobResponse;
use Google\Ads\GoogleAds\V1\Services\GetMutateJobRequest;
use Google\Ads\GoogleAds\V1\Services\ListMutateJobResultsRequest;
use Google\Ads\GoogleAds\V1\Services\ListMutateJobResultsResponse;
use Google\Ads\GoogleAds\V1\Services\MutateOperation;
use Google\Ads\GoogleAds\V1\Services\RunMutateJobRequest;
...
class MutateJobServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.MutateJobService';
