 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/ad_group_feed_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\AdGroupFeed;
use Google\Ads\GoogleAds\V1\Services\AdGroupFeedOperation;
use Google\Ads\GoogleAds\V1\Services\GetAdGroupFeedRequest;
use Google\Ads\GoogleAds\V1\Services\MutateAdGroupFeedsRequest;
use Google\Ads\GoogleAds\V1\Services\MutateAdGroupFeedsResponse;
...
class AdGroupFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.AdGroupFeedService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the ad group feed to fetch.
     ...
     * ```
     *
     * @param string                 $customerId   The ID of the customer whose ad group feeds are being modified.
     * @param AdGroupFeedOperation[] $operations   The list of operations to perform on individual ad group feeds.
     * @param array                  $optionalArgs {
     *                                             Optional.
     *
