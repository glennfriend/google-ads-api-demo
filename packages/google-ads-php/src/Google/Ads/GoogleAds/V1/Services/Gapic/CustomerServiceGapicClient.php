 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/customer_service.proto
...
use Google\Ads\GoogleAds\V1\Services\CreateCustomerClientRequest;
use Google\Ads\GoogleAds\V1\Services\CreateCustomerClientResponse;
use Google\Ads\GoogleAds\V1\Services\CustomerOperation;
use Google\Ads\GoogleAds\V1\Services\GetCustomerRequest;
use Google\Ads\GoogleAds\V1\Services\ListAccessibleCustomersRequest;
use Google\Ads\GoogleAds\V1\Services\ListAccessibleCustomersResponse;
use Google\Ads\GoogleAds\V1\Services\MutateCustomerRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCustomerResponse;
...
class CustomerServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.CustomerService';
