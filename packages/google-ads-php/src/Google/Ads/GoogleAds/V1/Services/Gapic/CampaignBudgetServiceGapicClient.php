 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/campaign_budget_service.proto
...
use Google\Ads\GoogleAds\V1\Services\GetCampaignBudgetRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCampaignBudgetsRequest;
...
class CampaignBudgetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.CampaignBudgetService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the campaign budget to fetch.
     ...
     * ```
     *
     * @param string                    $customerId   The ID of the customer whose campaign budgets are being modified.
     * @param CampaignBudgetOperation[] $operations   The list of operations to perform on individual campaign budgets.
     * @param array                     $optionalArgs {
     *                                                Optional.
     *
