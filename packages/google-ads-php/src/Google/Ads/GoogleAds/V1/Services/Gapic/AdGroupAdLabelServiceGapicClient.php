 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/ad_group_ad_label_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\AdGroupAdLabel;
use Google\Ads\GoogleAds\V1\Services\AdGroupAdLabelOperation;
use Google\Ads\GoogleAds\V1\Services\GetAdGroupAdLabelRequest;
use Google\Ads\GoogleAds\V1\Services\MutateAdGroupAdLabelsRequest;
use Google\Ads\GoogleAds\V1\Services\MutateAdGroupAdLabelsResponse;
...
class AdGroupAdLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.AdGroupAdLabelService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the ad group ad label to fetch.
     ...
     * ```
     *
     * @param string                    $customerId   ID of the customer whose ad group ad labels are being modified.
     * @param AdGroupAdLabelOperation[] $operations   The list of operations to perform on ad group ad labels.
     * @param array                     $optionalArgs {
     *                                                Optional.
     *
